	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	   <div class="layui-tab-item layui-show">
                    ...
                    <?php if (check_level('mod')) {?>
                    <button type="submit" name="submit" value="copy" class="layui-btn">复制</button>
                    <button type="submit" name="submit" value="move" class="layui-btn">移动</button>
                    <?php } ?>
                    <?php if (check_level('del')) {?>
			     	...
			     	<?php if ($this->getVar('baidu_zz_token')) {?>
			     		<button type="submit" name="submit" value="baiduzz" class="layui-btn">百度推送</button>
			     	<?php } ?>
			     	<?php if ($this->getVar('baidu_xzh_appid')) {?>
			     		<button type="submit" name="submit" value="baiduxzh" class="layui-btn">熊掌号推送</button>
			     	<?php } ?>
			     	 <?php } ?>
			     	<script>
...
<?php return array (
  0 => '/www_php/pbootcms/apps/admin/view/default/common/head.html',
  1 => '/www_php/pbootcms/apps/admin/view/default/common/ueditor.html',
  2 => '/www_php/pbootcms/apps/admin/view/default/common/foot.html',
); ?>