...
$.ajax({
    type: 'GET',
	url: 'https://www.pbootcms.com/index.php?p=upgrade/check&version=<?php echo APP_VERSION;?>.<?php echo RELEASE_TIME;?>.<?php echo $this->getVar('revise');?>&branch=<?php echo $this->getVar('branch');?>',
	dataType: 'json',
...
<?php return array (
  ...
  1 => '/www_php/pbootcms/apps/admin/view/default/common/foot.html',
); ?>